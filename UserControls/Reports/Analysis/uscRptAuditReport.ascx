<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptAuditReport.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptAuditReport" %>
