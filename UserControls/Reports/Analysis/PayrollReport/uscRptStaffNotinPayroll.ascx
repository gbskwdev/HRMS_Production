<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptStaffNotinPayroll.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.PayrollReport.uscRptStaffNotinPayroll" %>
...
<%--                    <dx:ASPxButton ID="btnExportToPDF" runat="server" CssClass="btnExportToPDF_analysis" ToolTip="Export to PDF" OnClick="btnExportPDF_Click">
            ...
            <dx:ASPxGridView ID="ASPxGridView1" Theme="MetropolisBlue" runat="server" OnDataBinding="ASPxGridView1_DataBinding" EnableCallBacks="true" EnableViewState="false"
