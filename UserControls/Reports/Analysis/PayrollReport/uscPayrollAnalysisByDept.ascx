<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscPayrollAnalysisByDept.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.PayrollReport.uscPayrollAnalysisByDept" %>
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxButton ID="btnGet" CssClass="btnGet_analysis" ClientInstanceName="btnGetData" runat="server" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){ SetCustomFilterParams(); CallbackPanel1.PerformCallback(0+'|page'); }" />
                        ...
                        <dx:ASPxButton ID="btnDrillUp" CssClass="btnDrillUp_analysis" runat="server" AutoPostBack="False">
                            <ClientSideEvents Click="function(s,e){ SetCustomFilterParams(); CallbackPanel1.PerformCallback(0+'|prev');}" />
...
<%--                    <td>
            ...
            <br />
            <dx:ASPxGridView ID="ASPxGridView1" Theme="MetropolisBlue" runat="server" OnDataBinding="ASPxGridView1_DataBinding" EnableCallBacks="true" 
                EnableViewState="false" ClientSideEvents-EndCallback="function(s,e){ CallbackPanel2.PerformCallback();}" >
                
                <ClientSideEvents BeginCallback="function(s,e){ SetCustomFilterParams();}" />
