<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptStaffOvertime.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptStaffOvertime" %>
