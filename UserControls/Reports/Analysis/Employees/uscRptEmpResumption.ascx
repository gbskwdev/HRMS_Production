<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptEmpResumption.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptEmpResumption" %>
...
<%--                        <dx:ASPxButton CssClass="btnExportToPDF_analysis" ID="btnExportToPDF" runat="server" OnClick="btnExportPDF_Click">
            ...
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="MetropolisBlue" OnDataBinding="ASPxGridView1_DataBinding" EnableCallBacks="true" EnableViewState="false"
                OnDataBound="ASPxGridView1_DataBound" ClientSideEvents-EndCallback="function(s,e){ CallbackPanel2.PerformCallback(); }"
                EnableCallbackAnimation="True" ClientInstanceName="ASPxGridView1">
