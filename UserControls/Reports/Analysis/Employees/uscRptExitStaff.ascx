<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptExitStaff.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptExitStaff" %>
...
<dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" CssClass="dxgvtbl" runat="server" ClientInstanceName="CallbackPanel1" OnCallback="ASPxCallbackPanel1_Callback"
    ClientSideEventsEndCallback="function(s,e){ CallbackPanel2.PerformCallback(); }">
    ...
    <PanelCollection>
        <dx:PanelContent runat="server">
            <table>
                ...
                <tr>
                    <%--<td>
                        <dx:ASPxLabel CssClass="lblPeriod_analysis" ID="lblPeriod" runat="server" Text="Period"></dx:ASPxLabel>
                    </td>--%>
                    <td>
