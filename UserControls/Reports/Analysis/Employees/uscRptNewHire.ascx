<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptNewHire.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptNewHire" %>
...
<dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" CssClass="dxgvtbl" runat="server" ClientInstanceName="CallbackPanel1" OnCallback="ASPxCallbackPanel1_Callback" ClientSideEvents-EndCallback="function(s,e){ CallbackPanel2.PerformCallback(); }">
    <PanelCollection>
        <dx:PanelContent runat="server">
            <table>
                ...
                <tr>
                    <td>
                        <dx:ASPxDateEdit ID="dtFrom" CssClass="dtFrom_analysis" ClientInstanceName="dtFrom" runat="server" Height="42px" DisplayFormatString="dd/MM/yyyy"
                            EditFormatString="dd/MM/yyyy" AutoPostBack="false">
                        </dx:ASPxDateEdit>
                    </td>
                    <td>
            ...
            <%--            <dx:ASPxGridView ID="ASPxGridView1" runat="server" OnDataBinding="ASPxGridView1_DataBinding" EnableCallBacks="true" EnableViewState="false"
