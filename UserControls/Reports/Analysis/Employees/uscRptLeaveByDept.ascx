<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptLeaveByDept.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptLeaveByDept" %>
