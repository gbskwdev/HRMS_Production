...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptEmployeeAttendance.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptEmployeeAttendance" %>
...
<%--                        <dx:ASPxButton CssClass="btnExportToPDF_analysis" ID="btnExportToPDF" runat="server" OnClick="btnExportPDF_Click">
            ...
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="MetropolisBlue" OnDataBinding="ASPxGridView1_DataBinding" EnableCallBacks="true" EnableViewState="false"
                OnDataBound="ASPxGridView1_DataBound" Styles-AlternatingRow-Enabled="true" EnableCallbackAnimation="True" ClientInstanceName="ASPxGridView1" Settings-VerticalScrollBarStyle="Standard">
