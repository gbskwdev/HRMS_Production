<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptEmpOvertime.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.Employees.uscRptEmpOvertime" %>
