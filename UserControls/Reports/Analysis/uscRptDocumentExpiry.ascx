<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscRptDocumentExpiry.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.uscRptDocumentExpiry" %>
...
<%--<dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" runat="server"
    ...
    <PanelCollection>
        <dx:PanelContent runat="server">
            ...
            <dx:ASPxGridView Theme="MetropolisBlue" ID="ASPxGridView1" Styles-AlternatingRow-Enabled="true" runat="server" OnDataBinding="ASPxGridView1_DataBinding" 
