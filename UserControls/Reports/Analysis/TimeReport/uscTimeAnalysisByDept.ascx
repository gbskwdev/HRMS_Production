<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscTimeAnalysisByDept.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.TimeReport.uscTimeAnalysisByDept" %>
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxButton ID="btnGet" CssClass="btnGet_analysis" ClientInstanceName="btnGetData" runat="server" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){ SetCustomFilterParamsTime(); CallbackPanel1.PerformCallback(0+'|page'); }" />
                    ...
                    <td>
                        ...
                        <dx:ASPxButton ID="btnDrillUp" CssClass="btnDrillUp_analysis" runat="server" AutoPostBack="False">
                            <ClientSideEvents Click="function(s,e){ SetCustomFilterParamsTime(); CallbackPanel1.PerformCallback(0+'|prev');}" />
