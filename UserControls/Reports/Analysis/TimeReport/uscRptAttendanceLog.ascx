<%@ Control Language="C#" AutoEventWireup="False" CodeBehind="uscRptAttendanceLog.ascx.cs" Inherits="HCM10.Web.UserControls.Reports.Analysis.TimeReport.uscRptAttendanceLog" %>
...
<dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" CssClass="dxgvtbl" runat="server" ClientInstanceName="CallbackPanel1" OnCallback="ASPxCallbackPanel1_Callback">
    <PanelCollection>
        <dx:PanelContent runat="server">
            ...
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="MetropolisBlue" OnDataBinding="ASPxGridView1_DataBinding"
                EnableCallBacks="True" EnableViewState="false" OnDataBound="ASPxGridView1_DataBound"
                EnableCallbackAnimation="false" ClientInstanceName="ASPxGridView1" Settings-VerticalScrollBarStyle="Standard">
