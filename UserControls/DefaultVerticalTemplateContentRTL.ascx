<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContentRTL.ascx.cs" ClassName="DefaultVerticalTemplateContentRTL" Inherits="HCM10.Web.UserControls.DefaultVerticalTemplateContentRTL" %>
